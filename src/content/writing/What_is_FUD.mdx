...
kpi:
  - value: "AI"
    label: "Generative engines echo discussions, ensure the right conversations are echoed"
  - value: "Community"
    label: "Human voices build trust and feel natural"
  - value: "Education & Transparency"
    label: "Information limits Fears Uncertainty, and Doubt"
...
> In crypto, it spreads even faster.
...
In May 2023, Ledger announced **Ledger Recover**. Patch notes left gaps that were filled with worst-case assumptions.  
...
The future of communication is **GEO: Generative Engine Optimization.** Ensure AI assistants return your facts, not unchecked FUD.
...
<Figure
  src="/writing/What_is_FUD/Key_Takeaways.png"
  alt="Key Takeaways"
  caption="Summary of defense principles"
/>
