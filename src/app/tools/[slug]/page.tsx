...
export default async function Page({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (!doc || !doc.frontmatter?.title) {
    ...
    // site navigates back to `/tools/${slug}`.
  ...
  return (
    <CaseStudyLayout frontmatter={doc.frontmatter} related={related} basePath="/tools">
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: doc.frontmatter.title, item: `${SITE_URL}/tools/${slug}` },
            ],
          }),
        }}
      />
